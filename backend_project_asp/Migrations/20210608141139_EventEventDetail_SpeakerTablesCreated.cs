...
{
    public partial class EventEventDetail_SpeakerTablesCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Day = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue:DateTime.UtcNow)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetailedVenue = table.Column<string>(type: "nvarchar(max)", nullable: true),
